...
export class ConfigService {
  ...
  constructor() {
    ...
    Object.assign(configuration, { ...ConfigService.getDotenvConfiguration(), ...process.env });

    const validationResult = validateSync(configuration, { whitelist: true, forbidUnknownValues: true });
